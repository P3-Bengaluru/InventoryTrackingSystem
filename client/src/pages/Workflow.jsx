...
export default function WorkflowList({ title, eyebrow, description, icon: Icon, endpoint, actionLabel, onAction }) {
    ...
    <div className="page-stack">
      ...
      <div className="panel">
            ...
            <>
                                ...
                                ? (
                                  <div className="asset-cell">
                                    <div className="asset-thumb">
                                      {/* Assume we have an icon mapping; for now use generic */}
                                      <Package size={16} />
                                    </div>
                                    <strong>{value}</strong>
                                  </div>
              ...
              {rows.length === 0 && (
                <EmptyState
                  ...
                  text="There are no items matching your current filters."
                />
              )}
            </>
          )}
        ...
        <div className="table-footer">
          <span>Showing <strong>{rows.length}</strong> records</span>
